...
def openface_nn4_small2(weights=None):
    ...
    print('Loaded openface nn4.small2 model')
    if weights is not None:
        model.load_weights(weights)
        print('Loaded in weights from {}'.format(weights))
    return model

if __name__ == '__main__':
   model = openface_nn4_small2(weights='nn4.small2.weights.h5')
   model.summary()
   import numpy as np
   model.predict_on_batch(np.zeros((1,96,96,3)))